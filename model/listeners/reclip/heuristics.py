...
class Heuristics:
    ...
    def __init__(self):#, args: Namespace = None):
        self.enable_relations = True#not args or not args.no_rel
        self.enable_superlatives = True#not args or not args.no_sup
        self.enable_nulls = True#not args or not args.no_null
        self.enable_ternary = False#not args or args.ternary
