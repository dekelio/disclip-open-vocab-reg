...
class Parse(RefMethod):
    ...
    def __init__(self): #args: Namespace = None):
        #self.args = args
        self.box_area_threshold = 0.0#args.box_area_threshold
        self.baseline_threshold = float("inf")#args.baseline_threshold
        self.temperature = 1.0#args.temperature
        self.superlative_head_only = False#args.superlative_head_only
        self.expand_chunks = False#args.expand_chunks
        self.branch = True#not args.parse_no_branch
        self.possessive_expand = True#not args.possessive_no_expand
    ...
    def execute_entity(self,
        ...
        if self.baseline_threshold == float("inf") or m1 < self.baseline_threshold * m2:
            ...
            for tokens, ent2 in ent.relations:
                ...
                if not False:#self.args.no_possessive:
    ...
    def _filter(self,
        ...
        kwargs = {
            "softmax": True, #not self.args.sigmoid,
            "temperature": 1.0, #self.args.temperature,
        }
        if root:
